...
import developerLight from '../../images/Programming-bro.svg';
import developerDark from '../../images/Programming-bro.svg';
	...
	return (
		...
		>
			<div className="w-full md:w-1/3 text-left">
				...
				>
					I enjoy solving complex problems by writing code.
				</motion.p>
				<motion.div
					initial={{ opacity: 0 }}
					animate={{ opacity: 1 }}
			...
			<motion.div
				...
				transition={{ ease: 'easeInOut', duration: 0.9, delay: 0.2 }}
				className="w-full sm:w5/6 text-right float-right mt-8 sm:mt-0"
			>
				<img
					src={
